...
- Games analyzed: `1`
- Speeds: `blitz, bullet`
- Time controls: `120+1, 180+2, 180+3, 240+2, 240+3, 300+2, 300+3, 60+1, 90+1`
- Modes: `rated`
- Since UTC: `2026-06-08T19:19:23+00:00`
- Results: `{'draw': 1}`
...
- `bullet`: `+1` rating over `1` games

## Rating Impact by Time Control

- `60+1 white`: `+1` rating over `1` games

## Rating Impact by Opening

- `Ruy Lopez: Berlin Defense, Anti-Berlin Variation`: `+1` rating over `1` games

## Rating Impact by Opening Context

- `Ruy Lopez: Berlin Defense, Anti-Berlin Variation | white | bullet`: `+1` rating over `1` games

## Rating Impact by Opponent

- `Cheszter | bullet | 60+1`: `+1` rating over `1` games

## Score by Opponent

- `Cheszter | bullet | 60+1`: W-D-L `0-1-0`, score `50.0%` over `1` games

## Focused Rating Impact by Time Control

- `60+1`: `+1` rating over `1` games
...
- `Ruy Lopez: Berlin Defense, Anti-Berlin Variation | white | bullet | 60+1`: `+1` rating over `1` games

## Focused Score by Opening Context

- `Ruy Lopez: Berlin Defense, Anti-Berlin Variation | white | bullet | 60+1`: W-D-L `0-1-0`, score `50.0%` over `1` games
...
- No clock-rich normal losses found at the configured threshold.
...
- No high-clock normal loss contexts found.

## High-Clock Normal Losses

- No high-clock normal losses found at the configured threshold.

## Clock-Pressure Miss Contexts

- No clock-pressure miss contexts found.
