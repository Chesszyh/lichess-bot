...
- `coda_bot | bullet | 120+1`: risk `3`, losses `1`, lower-rated draws `0`, rating-negative draws `0`, rating `-5`, latest `2026-06-08T20:00:28+00:00`
- `friendlybot_1700 | bullet | 60+1`: risk `2`, losses `0`, lower-rated draws `1`, rating-negative draws `1`, rating `-1`, latest `2026-06-08T17:49:59+00:00`
...
- `1` x Semi-Slav Defense: Accelerated Meran Variation
...
- `60+1 white`: `-18` rating over `7` games
- `120+1 black`: `-10` rating over `3` games
- `90+1 black`: `-8` rating over `4` games
...
- `Semi-Slav Defense`: `-4` rating over `1` games
...
- `Semi-Slav Defense | black | blitz`: `-4` rating over `1` games
...
- `TakticproChess | blitz | 240+2`: `-4` rating over `1` games
- `abdcebot | bullet | 60+1`: `-3` rating over `2` games
...
- `CupchessBot | bullet | 90+1`: W-D-L `0-1-1`, score `25.0%` over `2` games
- `abdcebot | bullet | 60+1`: W-D-L `0-2-1`, score `33.3%` over `3` games

## Focused Rating Impact by Time Control

- `60+1`: `-23` rating over `8` games
- `90+1`: `-5` rating over `6` games
...
- `60+1`: W-D-L `0-5-4`, score `27.8%` over `9` games
- `90+1`: W-D-L `0-4-2`, score `33.3%` over `6` games
...
- `Sicilian Defense: Najdorf Variation, English Attack | black | blitz | 180+3`: `-5` rating over `1` games
- `Semi-Slav Defense | black | blitz | 240+2`: `-4` rating over `1` games
- `Ruy Lopez: Berlin Defense, Rio Gambit Accepted | white | bullet | 60+1`: `-1` rating over `1` games
- `Catalan Opening: Open Defense, Modern Sharp Variation | black | blitz | 180+2`: `+0` rating over `1` games
...
- `Semi-Slav Defense | black | blitz | 240+2`: W-D-L `0-0-1`, score `0.0%` over `1` games
- `Semi-Slav Defense: Accelerated Meran Variation | black | bullet | 120+1`: W-D-L `0-0-1`, score `0.0%` over `1` games
- `Semi-Slav Defense: Anti-Moscow Gambit | black | bullet | 120+1`: W-D-L `0-0-1`, score `0.0%` over `1` games
- `Sicilian Defense: Najdorf Variation, English Attack | black | blitz | 180+3`: W-D-L `0-0-1`, score `0.0%` over `1` games
- `Ruy Lopez: Berlin Defense, Anti-Berlin Variation | white | bullet | 60+1`: W-D-L `0-2-0`, score `50.0%` over `2` games
- `Ruy Lopez: Berlin Defense, Berlin Wall | white | blitz | 180+2`: W-D-L `0-2-0`, score `50.0%` over `2` games
...
- `TakticproChess | blitz | 240+2`: `-4` rating over `1` games
- `abdcebot | bullet | 60+1`: `-3` rating over `2` games
- `friendlybot_1700 | bullet | 60+1`: `-1` rating over `1` games
...
- `CupchessBot | bullet | 90+1`: W-D-L `0-1-1`, score `25.0%` over `2` games
- `abdcebot | bullet | 60+1`: W-D-L `0-2-1`, score `33.3%` over `3` games
- `CupchessBot | bullet | 120+1`: W-D-L `0-2-0`, score `50.0%` over `2` games
...
- `1` x `d4 d5 c4 c6 Nf3 Nf6 Nc3 e6 e3 a6 b3 Bb4 | black | bullet | Normal`
- `1` x `d4 Nf6 c4 e6 Nc3 Bb4 e3 O-O Bd3 d5 a3 dxc4 | white | bullet | Time forfeit`

## Lower-Rated Draws

- Lower-rated draws found: `1`
...
- `47s` left in `ilovecatgirl vs abdcebot - MznBGMQZ.pgn` vs `abdcebot`: Nimzo-Indian Defense: Normal Variation, Classical Defense
...
- `-392.66` after `Ke8` in `CupchessBot vs ilovecatgirl - 21mY5MXC.pgn` vs `CupchessBot`: `-7.31` to `-399.97` (Italian Game: Giuoco Pianissimo, Italian Four Knights Variation | black | 90+1)
...
- `-26.36` after `Kxg5` in `coda_bot vs ilovecatgirl - HefYDfeq.pgn` vs `coda_bot`: `-3.90` to `-30.26` (Semi-Slav Defense: Accelerated Meran Variation | black | 120+1)
...
- `2026-06-08 18:54:11+00:00` `CupchessBot vs ilovecatgirl - 21mY5MXC.pgn` vs `CupchessBot`: Italian Game: Giuoco Pianissimo, Italian Four Knights Variation
- `2026-06-08 17:33:09+00:00` `ilovecatgirl vs abdcebot - MznBGMQZ.pgn` vs `abdcebot`: Nimzo-Indian Defense: Normal Variation, Classical Defense
