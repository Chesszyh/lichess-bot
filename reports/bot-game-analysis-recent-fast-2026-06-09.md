...
- `abdcebot | bullet | 60+1`: risk `3`, losses `1`, lower-rated draws `0`, rating-negative draws `0`, rating `-5`, latest `2026-06-08T17:33:09+00:00`
- `TakticproChess | blitz | 240+2`: risk `3`, losses `1`, lower-rated draws `0`, rating-negative draws `0`, rating `-4`, latest `2026-06-08T08:05:00+00:00`
...
- `rated`: `-33` rating over `32` games

## Rating Impact by Speed

- `bullet`: `-32` rating over `20` games
...
- `120+1 black`: `-5` rating over `2` games
...
- `Ruy Lopez: Marshall Attack`: `+0` rating over `1` games
...
- `Ruy Lopez: Marshall Attack | white | blitz`: `+0` rating over `1` games
...
- `120+1`: W-D-L `1-3-1`, score `50.0%` over `5` games
...
- `Ruy Lopez: Berlin Defense, Rio Gambit Accepted | white | bullet | 60+1`: W-D-L `0-2-0`, score `50.0%` over `2` games
...
- `-51.65` after `Kxg6` in `TakticproChess vs ilovecatgirl - cArqfmSd.pgn` vs `TakticproChess`: `-30.72` to `-82.37` (Semi-Slav Defense | black | 240+2)
