...
- `odonata-bot | blitz | 180+2`: `-16` rating over `2` games
- `Void_Bot | blitz | 180+2`: `-13` rating over `5` games
...
- `HE3HAKOMKA_HOMEP1 | blitz | 180+2`: `-10` rating over `3` games
- `duchessAI | blitz | 180+3`: `-10` rating over `3` games
...
- `Lili-ai | blitz | 180+2`: W-D-L `0-0-1`, score `0.0%` over `1` games
...
- `1` x `d4 Nf6 c4 e6 g3 d5 Nf3 dxc4 Bg2 Nc6 Qa4 Bb4+ | black | blitz | 180+1`
