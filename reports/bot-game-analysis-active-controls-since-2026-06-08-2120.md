...
- `rated`: `-4` rating over `3` games

## Rating Impact by Speed

- `bullet`: `-4` rating over `3` games

## Rating Impact by Time Control

- `120+1 black`: `-6` rating over `1` games
- `120+1 white`: `+0` rating over `1` games
- `90+1 white`: `+2` rating over `1` games
...
- `Ruy Lopez: Berlin Defense, Rio Gambit Accepted`: `+2` rating over `1` games
...
- `Ruy Lopez: Berlin Defense, Rio Gambit Accepted | white | bullet | 90+1`: `+2` rating over `1` games
...
- `Ruy Lopez: Berlin Defense, Rio Gambit Accepted | white | bullet | 90+1`: W-D-L `0-1-0`, score `50.0%` over `1` games
...
- No lower-rated draw contexts found.
...
- `-2.48` after `Re6` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-8.37` to `-10.85` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-1.41` after `Rd4+` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-5.14` to `-6.55` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-1.34` after `Re2+` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-6.67` to `-8.01` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-0.90` after `Rb3+` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-4.06` to `-4.96` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-0.89` after `Nxf6` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `+1.27` to `+0.38` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-0.88` after `c2` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-0.83` to `-1.71` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-0.72` after `Ke7` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `+1.63` to `+0.91` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-0.68` after `Rxc1` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-1.89` to `-2.57` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
- `-0.59` after `Bb4` in `Fischer_Bot vs ilovecatgirl - sSos0k3i.pgn` vs `Fischer_Bot`: `-0.15` to `-0.74` (Semi-Slav Defense: Anti-Moscow Gambit | black | 120+1)
